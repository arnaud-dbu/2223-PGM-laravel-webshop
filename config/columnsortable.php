...
return [
    ...
    */
    'columns'                       => [
        'alpha'   => [
            'rows'  => ['description', 'email', 'firstname', 'lastname', 'name', 'slug', 'artisan', 'status'],
            'class' => 'fa fa-sort-alpha',
        ],
        'amount'  => [
            'rows'  => ['amount', 'price', 'stock', 'id', 'total', 'user_id'],
            'class' => 'fa fa-sort-amount',
        ],
        'numeric' => [
            'rows'  => ['created_at', 'updated_at', 'level', 'phone_number'],
